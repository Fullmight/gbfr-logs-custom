...
import { Gear, House, Infinity as InfinityIcon } from "@phosphor-icons/react";
      ...
      >
        ...
        <AppShell.Navbar p="sm">
          <AppShell.Section grow>
            ...
            <NavLink label="Conflux" leftSection={<InfinityIcon size="1rem" />} component={Link} to="/logs/conflux" />
          </AppShell.Section>
          <AppShell.Section>
